...
>
  <div className="max-w-4xl mx-auto bg-white/70 backdrop-blur-md p-8 rounded-2xl shadow-xl">

    {/* Header Buttons */}
    <div className="flex justify-between items-center mb-6">
      <button
        onClick={() => navigate("/")}
        className="text-sm px-3 py-1 bg-gray-300 hover:bg-gray-400 text-gray-800 rounded"
      >
        ← Back
      </button>
    ...
    <p className="text-sm text-gray-600 italic mb-4">Category: {post.category}</p>
    ...
    <div className="text-base text-gray-800 whitespace-pre-line leading-relaxed mb-10">
      {post.content}
    </div>
    ...
    <div className="mt-10">
      ...
      <form onSubmit={handleCommentSubmit} className="mb-6">
        <textarea
          ...
          className="w-full border border-gray-300 p-3 rounded mb-2 text-gray-800"
          required
        ></textarea>
        <input
          type="text"
          ...
          className="w-full border border-gray-300 p-3 rounded mb-4 text-gray-800"
        />
        <button
          type="submit"
      ...
      {comments.map((comment) => (
        <div key={comment._id} className="bg-white/80 p-4 rounded-lg mb-4 shadow hover:shadow-md transition-shadow">
